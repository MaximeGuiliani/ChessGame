...
public class TestChess {
	...
	public static void main(String[] args) {
		...
		resultTest = testAuthorizedMove("boardConfigurationFiles/FullBoard.txt", new Coordinates(0, 1),
				new Coordinates(0, 2));
		if (resultTest == true)
		...
		System.out.print("test 1 : ");
		resultTest = testPlayableMove("boardConfigurationFiles/FullBoard.txt", new Coordinates(0, 1),
				new Coordinates(0, 2));
		if (resultTest == true)
			System.out.println("pass");
		else
